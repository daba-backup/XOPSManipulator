...
public class Config {
	...
	public String toString() {
		...
		ret+="[turn up]"+separator;
		ret+=turn_up+separator;
		ret+="[turn down]"+separator;
		ret+=turn_down+separator;
		ret+="[turn left]"+separator;
		ret+=turn_left+separator;
		ret+="[turn right]"+separator;
		ret+=turn_right+separator;
		ret+="[move forward]"+separator;
		ret+=move_forward+separator;
		ret+="[move backward]"+separator;
		ret+=move_backward+separator;
		ret+="[move left]"+separator;
		ret+=move_left+separator;
		ret+="[move right]"+separator;
		ret+=move_right+separator;
		ret+="[walk]"+separator;
		ret+=walk+separator;
		ret+="[jump]"+separator;
		ret+=jump+separator;
		ret+="[reload]"+separator;
		ret+=reload+separator;
		ret+="[drop weapon]"+separator;
		ret+=drop_weapon+separator;
		ret+="[zoom]"+separator;
		ret+=zoom+separator;
		ret+="[fire mode]"+separator;
		ret+=fire_mode+separator;
		ret+="[switch weapon]"+separator;
		ret+=switch_weapon+separator;
		ret+="[weapon1]"+separator;
		ret+=weapon1+separator;
		ret+="[weapon2]"+separator;
		ret+=weapon2+separator;
		ret+="[fire]"+separator;
		ret+=fire+separator;
		ret+="[mouse sensitivity]"+separator;
		ret+=mouse_sensitivity+separator;
		ret+="[brightness]"+separator;
		ret+=brightness+separator;
		ret+="[window mode]"+separator;
		ret+=window_mode+separator;
		ret+="[enable sound]"+separator;
		ret+=enable_sound+separator;
		ret+="[enable blood]"+separator;
		ret+=enable_blood+separator;
		ret+="[invert mouse]"+separator;
		ret+=invert_mouse+separator;
		ret+="[frame skip]"+separator;
		ret+=frame_skip+separator;
		ret+="[another gunsight]"+separator;
		ret+=another_gunsight+separator;
		ret+="[name]"+separator;
		ret+=name;
