...
public class CharacterDataCodeParser {
	private Logger logger = LoggerFactory
			.getLogger(CharacterDataCodeParser.class);
			...
			try {
				switch (field_name) {
					case "texture" :
						...
						CharacterTextureType texture_type = CharacterSpecifierConverter
								.GetXOPSTextureTypeFromOpenXOPSTextureID(itemp);
						character_data.SetTextureType(texture_type);
						break;
					case "model" :
						value = value.replace(" ", "");
						itemp = Integer.parseInt(value);
						CharacterModelType[] model_types = CharacterModelType
								.values();
					...
					case "AIlevel" :
						value = value.replace(" ", "");
						itemp = Integer.parseInt(value);
						CharacterAILevel ai_level = CharacterSpecifierConverter
								.GetXOPSAILevelFromOpenXOPSAILevel(itemp);
