...
public class WeaponBinSpecifierAndEnumConverter {
	private static Logger logger = LoggerFactory
			.getLogger(WeaponBinSpecifierAndEnumConverter.class);
	...
	public static int GetBinSpecifierFromWeaponModelType(
			WeaponModelType model_type) {
		int spc = 0x00;
	...
	public static WeaponTextureType GetWeaponTextureTypeFromBinSpecifier(
			int spc) {
	...
	public static int GetBinSpecifierFromWeaponTextureType(
			WeaponTextureType texture_type) {
		int spc = 0x00;
	...
	public static WeaponShootingStance GetWeaponShootingStanceFromBinSpecifier(
			int spc) {
		...
		switch (spc) {
			...
			case 0x1B :
				...
				break;
			default :
				logger.warn("Unknown equipment method specifier. specifier={}",
						spc);
	...
	public static int GetBinSpecifierFromWeaponShootingStance(
			WeaponShootingStance shooting_stance) {
		int spc = 0x08;
	...
	public static int GetBinSpecifierFromWeaponScopeMode(
			WeaponScopeMode scope_mode) {
		int spc = 0x00;
