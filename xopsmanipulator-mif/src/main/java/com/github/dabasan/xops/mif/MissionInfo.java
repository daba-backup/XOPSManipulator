...
public class MissionInfo {
	...
	public String toString() {
		...
		ret += "mission_name:" + mission_name + separator;
		ret += "mission_formal_name:" + mission_formal_name + separator;
		ret += "bd1_filename:" + bd1_filename + separator;
		ret += "pd1_filename:" + pd1_filename + separator;
		ret += "sky_type:" + sky_type.toString() + separator;
		ret += "extra_hitcheck_flag:" + extra_hitcheck_flag + separator;
		ret += "darken_screen_flag:" + darken_screen_flag + separator;
		ret += "article_info_filename:" + article_info_filename + separator;
		ret += "image_1_filename:" + image1_filename + separator;
